# Enquanto a janela está aberta: うちに, 最中に, まで

> Lição `les:n3-tempo-01` · tópico `top:n3-tempo` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Usar ～うちに para dizer 'enquanto/antes que' uma janela de tempo se feche
- Distinguir a forma negativa ～ないうちに ('antes que comece') da lógica do português
- Empregar ～最中に para marcar 'bem no meio de' uma ação interrompida
...
### A janela de tempo que vai se fechar
No N3 você começa a falar de tempo com mais nuance: não basta dizer 'quando' ou 'enquanto', é preciso escolher se a ação aproveita uma oportunidade, acontece bem no centro de outra ou para num limite. Vamos abrir com três ferramentas.
...
まで
é duração contínua até um ponto ('trabalho ATÉ as 10', a ação dura o tempo todo);
までに
é prazo para algo pontual ('entregue ATÉ as 10', basta concluir antes). Decida conscientemente entre os dois.

### Palavras novas
Boa parte do vocabulário deste tópico abre com a sílaba い. Note os pares que soam igual e mudam de kanji.
- 意思 e 意志 soam ambos いし: o primeiro é 'intenção/vontade' em geral, o segundo enfatiza 'determinação'.
- 維持 (いじ) é 'manutenção', e 意識 (いしき) é 'consciência'.
- 異常 é 'anormal'; 以前 é 'antes de'.
- 命 é 'vida'; 一瞬 é 'um instante'.
- 泉, 板, 居間 e 居眠り são, na ordem, nascente, tábua, sala de estar e cochilo.
- 今に ('em breve') e 今にも ('a qualquer momento') combinam muito com a ideia de janela de tempo.

> **[l1-pitfall]**
Armadilha PT. Em いし, mantenha as duas batidas iguais: い-し. Não levante o 'i' final nem martele a primeira mora como faria com a tônica do português.

### Kanji do bloco
Sete kanji de uso amplo. O 治 ('governar/curar') guarda o radical da água à esquerda; pense em 'acalmar as águas' para governar e curar.
- 法 método, lei.
- 性 gênero, natureza.
- 要 necessitar, essencial.
- 制 sistema, controle.
- 務 dever, tarefa.
- 成 tornar-se, formar.
...
#### Leitura
> 📖 明日は朝のうちに買い物をします。雨がふらないうちに帰るつもりです。昼までに仕事の電話もかけます。明るいうちにそうじをしておきたいです。六時までにぜんぶ終わります。 — Amanhã vou fazer as compras logo de manhã. Pretendo voltar antes que comece a chover. Até o meio-dia também vou fazer as ligações do trabalho. Quero deixar a limpeza feita enquanto ainda está claro. Até as seis fica tudo pronto.
...
- Diferencio まで (duração) de までに (prazo)
- Leio as 14 palavras novas e os 7 kanji do bloco
