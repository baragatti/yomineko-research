# Justificar com emoção: ～(ん)だもの e ～んだもん

> Lição `les:n3-causa-04` · tópico `top:n3-causa` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Justificar algo de forma emotiva com ～(ん)だもの
...
> **[warning]**
Tanto だもの quanto だもん são bem informais, comuns entre crianças, casais e amigos próximos. A variante もん é típica da fala feminina e infantil. Soam totalmente deslocadas no trabalho ou em situações formais, então reserve-as para momentos descontraídos e íntimos.

> **[l1-pitfall]**
Armadilha PT: isto não é um "porque" neutro como から sozinho. Carrega birra, charme ou autodefesa, como o nosso "ué, mas é porque..." dito com beicinho. Não troque por から num e-mail de trabalho.

#### Vocabulário desta lição
- 改善: melhoria, aperfeiçoamento; 回復: recuperação, melhora.
- 解釈: interpretação, leitura; 外交: diplomacia.
- 会合: reunião, encontro; 外出: sair, saída.
- 開始: início, começo; 快適: agradável, confortável.
- 飼う: criar, ter (animal); 抱える: carregar nos braços.
- 替える: substituir, trocar; 香り: aroma, fragrância.
- 画家: pintor, artista.
