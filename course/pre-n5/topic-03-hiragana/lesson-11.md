...
> Lição `les:pre-n5-hiragana-11` · tópico `top:pre-n5-hiragana` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Reconhecer e ler ん
- Pronunciar ん como uma sílaba nasal própria (sem virar 'ã'/'õ' do português)
- Escrever ん na ordem correta dos traços

**Introduz:** gramática [—] · vocabulário [—] · kanji [—] · kana [kana:hiragana-n]
...
- Pronuncio ん como uma sílaba própria (はん em dois tempos, não "hã").
- Não confundo ん com そ e consigo escrevê-lo na ordem correta do traço.
