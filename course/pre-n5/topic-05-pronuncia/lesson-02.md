...
> Lição `les:pre-n5-pronuncia-02` · tópico `top:pre-n5-pronuncia` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Entender que o ん é uma mora própria, com sua própria duração
- Evitar o erro de nasalizar a vogal anterior (como em 'mãe') e dar tempo ao ん
- Contar corretamente as moras de palavras com ん, como ほん (2) e にほん (3)
...
- Mantenho a vogal anterior oral (sem nasalizar como em "mãe") e dou tempo ao ん.
- Conto corretamente as moras: ほん (2), にほん (3), でんわ (3).
