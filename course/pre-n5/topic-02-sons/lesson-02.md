...
> Lição `les:pre-n5-sons-02` · tópico `top:pre-n5-sons` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Definir mora como a unidade de ritmo do japonês (um tempo de duração parecida)
- Contar quantas moras tem uma palavra, incluindo o n final, a consoante dobrada e as vogais longas
- Bater o ritmo de uma palavra japonesa em moras, e não em sílabas com acento de força como no português
...
- Conto cada kana, o n final e a consoante dobrada como 1 mora, e a vogal longa como 2 moras.
- Consigo bater palmas no ritmo de uma palavra (uma palma por mora) em vez de marcar acento de força.
...
- To-o-kyo-o = 4 moras. Cada vogal longa vale 2 moras (To-o = 2, kyo-o = 2), mesmo que a gente escreva so 'Tóquio' em portugues.
