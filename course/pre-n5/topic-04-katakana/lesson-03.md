# Katakana: a Família do SA (サシスセソ)

> Lição `les:pre-n5-katakana-03` · tópico `top:pre-n5-katakana` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Reconhecer e ler サ, シ, ス, セ, ソ
- Pronunciar シ como 'shi' (e não 'si') e ソ com o som cheio de 'o'
- Distinguir シ (shi) de ソ (so) pela direção dos traços
- Escrever cada kana da família na ordem correta dos traços

**Introduz:** gramática [—] · vocabulário [—] · kanji [—] · kana [kana:katakana-sa]
...
- Distingo シ (shi) de ソ (so) pela direção dos traços.
- Leio シ como "shi" (nunca "si") e ソ com o "o" cheio (nunca "u").
