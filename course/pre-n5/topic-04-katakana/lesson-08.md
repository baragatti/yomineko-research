# Katakana: a Família do YA (ヤユヨ)

> Lição `les:pre-n5-katakana-08` · tópico `top:pre-n5-katakana` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Reconhecer e ler ヤ, ユ e ヨ
- Lembrar que ヤ・ユ・ヨ têm os mesmos sons de や・ゆ・よ, só mudando o formato
- Escrever cada kana da família na ordem correta dos traços

**Introduz:** gramática [—] · vocabulário [—] · kanji [—] · kana [kana:katakana-ya]
...
- Lembro que ヤ・ユ・ヨ têm os mesmos sons de や・ゆ・よ.
- Não confundo ユ com コ nem ヨ com o número 3.
