# Katakana: a Família do TA (タチツテト)

> Lição `les:pre-n5-katakana-04` · tópico `top:pre-n5-katakana` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Reconhecer e ler タ, チ, ツ, テ, ト em katakana
- Distinguir ツ (tsu) de シ (shi) pela direção dos tracinhos e do traço longo
- Escrever cada kana da família na ordem correta dos traços

**Introduz:** gramática [—] · vocabulário [—] · kanji [—] · kana [kana:katakana-ta]
...
- Distingo ツ (tsu) de シ (shi) pela direção dos traços.
...
- チ = chi (como o 'tchi' carioca), nunca 'ti'.
