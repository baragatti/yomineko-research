# Katakana: a Família do KA (カキクケコ)

> Lição `les:pre-n5-katakana-02` · tópico `top:pre-n5-katakana` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Reconhecer e ler カ, キ, ク, ケ, コ
- Associar cada katakana ao seu hiragana correspondente (カ lembra か)
- Diferenciar os katakana parecidos カ, ク e ケ
- Escrever cada kana da família na ordem correta dos traços

**Introduz:** gramática [—] · vocabulário [—] · kanji [—] · kana [kana:katakana-ka]
...
#### Os cinco kana
- カ(ka): como o ca de "casa". É quase o か sem o pingo: imagine uma ca pa de super-herói tremulando.
- キ(ki): como o qui de "quilo". Lembra o き: pense numa ki tchen com duas prateleiras cortadas por uma diagonal.
...
- Diferencio os katakana parecidos カ, ク e ケ.
- Leio コ com o "o" cheio (nunca "u").
- Consigo escrever cada kana na ordem correta dos traços.

---

## Exercícios
### 1. (recognition) Qual katakana representa o som /ka/?
- **Resposta:** `{"choices": ["カ", "ク", "ケ"], "correct": "カ"}`
- カ = ka (lembra o hiragana か). Cuidado para não confundir com ク (ku) e ケ (ke).


### 2. (recognition) Que som tem コ?
- **Resposta:** `{"choices": ["ko", "ku", "ka"], "correct": "ko"}`
- コ = ko (som cheio, nunca 'ku').


### 3. (matching) Ligue cada katakana ao seu som.
- **Resposta:** `{"pairs": [["カ", "ka"], ["キ", "ki"], ["ク", "ku"], ["ケ", "ke"], ["コ", "ko"]]}`
- Os cinco kana da Família do KA. Repare como カ e ク e ケ se parecem, mas têm sons diferentes.


### 4. (production) Escreva o katakana do som /ku/.
- **Resposta:** `{"text": "ク", "accept": ["ク"]}`
- /ku/ = ク (o de cara pontuda, como um bico).
