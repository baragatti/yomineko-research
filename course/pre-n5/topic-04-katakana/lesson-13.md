...
> Lição `les:pre-n5-katakana-13` · tópico `top:pre-n5-katakana` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Reconhecer e ler as famílias ダ・ヂ・ヅ・デ・ド, バ・ビ・ブ・ベ・ボ e パ・ピ・プ・ペ・ポ
- Entender que ゛ (dakuten) vozeia o som e ゜ (handakuten) cria os sons P (só na linha do HA)
- Ler empréstimos em katakana que usam esses sons vozeados

**Introduz:** gramática [—] · vocabulário [—] · kanji [—] · kana [kana:katakana-ba, kana:katakana-da, kana:katakana-pa]
...
- ビ(bi):ヒ(hi) com as marquinhas.
- ブ(bu):フ(fu) com as marquinhas.
- ベ(be):ヘ(he) com as marquinhas.
- ボ(bo):ホ(ho) com as marquinhas.

#### A Família do PA (linha do HA + ゜)
- パ(pa):ハ(ha) com a bolinha.
- ピ(pi):ヒ(hi) com a bolinha.
- プ(pu):フ(fu) com a bolinha.
- ペ(pe):ヘ(he) com a bolinha.
...
> **[l1-pitfall]**
Ao ler em voz alta, segure as vogais finais limpas. Em português a gente fala "gatu", "leiti" sem perceber, mas no japonês ビデオ é "bi-de-o" (não "bideu") e ピアノ termina num "o" aberto e claro (nunca "pianu"). Não levante o "o" para "u" nem o "e" para "i": cada vogal mantém o seu som até o fim.
...
- Reconheço バ・ビ・ブ・ベ・ボ (linha do HA com ゛).
- Reconheço パ・ピ・プ・ペ・ポ (linha do HA com ゜) e diferencio ゛ de ゜.
- Consigo ler empréstimos simples como パン, バナナ e ピアノ.
