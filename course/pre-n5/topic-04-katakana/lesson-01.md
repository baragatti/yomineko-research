# Katakana: a Família do A (アイウエオ) e para que serve o katakana

> Lição `les:pre-n5-katakana-01` · tópico `top:pre-n5-katakana` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Entender para que serve o katakana (empréstimos, nomes estrangeiros, onomatopeias, ênfase)
- Reconhecer e ler ア, イ, ウ, エ, オ
- Perceber que katakana tem os mesmos sons do hiragana, só com formas diferentes
- Escrever cada kana da família na ordem correta dos traços

**Introduz:** gramática [—] · vocabulário [—] · kanji [—] · kana [kana:katakana-a]
...
#### Os cinco kana
- ア (a): o som a de "asa". Imagine um Anzol com um cabo cortando por cima.
...
- Sei que o katakana serve para empréstimos, nomes estrangeiros, onomatopeias e ênfase.
- Entendo que katakana tem os mesmos sons do hiragana, só com formas diferentes.
