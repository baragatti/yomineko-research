...
> Lição `les:n4-keigo-04` · tópico `top:n4-keigo` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Construir a forma honorífica produtiva お〜になる a partir da raiz ます de qualquer verbo, para falar com respeito das ações de outra pessoa
...
**Frases (por ID, do banco dissecado):** `sent:gen-96ce440b58e0`, `sent:gen-0114d50c684c`, `sent:gen-0e95f64b542d`, `sent:gen-9b17ac12d5f3`
...
- Reconheço esses padrões em avisos, recepção e atendimento ao cliente.
