...
> Lição `les:n4-passiva-03` · tópico `top:n4-passiva` · **needs_review** (Layer C, aguarda professor).
...
**Frases (por ID, do banco dissecado):** `sent:tatoeba-171507`, `sent:tatoeba-213986`, `sent:tatoeba-2140068`, `sent:tatoeba-9478237`
...
#### あまり ou ぜんぜん? Escolha pelo grau
A escolha entre os dois é uma escolha de força. Use あまり para relativizar com educação; use ぜんぜん/全然 para negar por completo.
- この町は近所の店があまりない = "não tem muita loja na vizinhança" (tem pouca).
...
- Lembro que os dois advérbios exigem um predicado negativo na frase.
- Reconheço o kanji 駅 (estação).
- Reconheço o kanji 旅 (viagem).
