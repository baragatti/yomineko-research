...
> Lição `les:n4-oracoes-relativas-03` · tópico `top:n4-oracoes-relativas` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Usar 間 (あいだ) para marcar uma duração paralela inteira ('enquanto / durante todo o tempo em que')
...
**Frases (por ID, do banco dissecado):** `sent:gen-aab58020a36f`, `sent:gen-c5f31a4dfcad`, `sent:gen-f18adf16a1e1`, `sent:tatoeba-79723`
...
- Reconheço 動 (mover) e 開 (abrir) nas frases do tópico.
