...
#### Kanji da lição: 重
O kanji 重 significa pesado, importante, prezar/respeitar e também "-vezes" (camadas empilhadas). Combina bem com o tema: uma ordem "pesa" conforme o registro. Mnemônico de forma: imagine caixas empilhadas uma sobre a outra, espremidas por um eixo no meio; pesadas e amontoadas. Leituras: on じゅう／ちょう, kun おも・い (pesado), かさ・ねる (empilhar).
...
#### Leitura
> 📖 かえったら、手をあらいなさい。それから、へやのそうじをしなさい。テレビを見る前に、本を読みなさい。ごはんは六時に食べなさい。母より。 — Quando chegar, lave as mãos. Depois, arrume o quarto. Antes de ver televisão, leia um livro. Jante às seis horas. Da mãe.
...
### 2. (cloze) Complete a ordem firme mas gentil que um professor dá ao aluno ('Estude.', verbo 勉強する na forma 〜なさい): 勉強＿＿＿＿。
