# Reforçar intenções e nuanças: ぜひ, なるべく, 〜まい, 〜のように

> Lição `les:n4-volitivo-07` · tópico `top:n4-volitivo` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Reforçar convites, pedidos e desejos com ぜひ ("sem falta")
- Suavizar intenções com なるべく ("na medida do possível")
- Reconhecer e usar 〜まい como recusa firme e como forte suposição negativa
...
#### Leitura
> 📖 今週はなるべくはやくうちにかえります。先週はおそくまで外にいて、つかれました。新しい店にも行きたいですが、なるべく休みたいです。今月はもうお金を使うまいと思います。 — Esta semana eu volto para casa o mais cedo possível. Na semana passada fiquei na rua até tarde e me cansei. Até queria ir na loja nova, mas quero descansar o máximo possível. Este mês eu decidi não gastar mais dinheiro.
...
- Sei comparar com 〜のように / 〜のような ("como", "feito").
- Reconheço 許り (ばかり) como "só/apenas" e como "acabar de".
