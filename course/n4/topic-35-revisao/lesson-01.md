...
Em português, a descrição vem depois do substantivo: "a pessoa que mora em Tóquio". Em japonês é o contrário: a frase inteira, com o verbo na forma simples, vemantes do substantivo, grudada nele, sem nenhuma palavra para "que":
...
## Exercícios
### 1. (recognition) {'pt-BR': 'Qual é a forma simples do PASSADO NEGATIVO de 行く (ir)?'}
- **Resposta:** `{"choices": ["行かなかった", "行きませんでした", "行かない", "行った"], "correct": "行かなかった"}`
- {'pt-BR': 'Passado negativo na forma simples: 行く → 行かない → 行かなかった. 行きませんでした é a forma polida; 行かない é o presente negativo; 行った é o passado afirmativo.'}


### 2. (recognition) {'pt-BR': "Na frase 昨日買った本 ('o livro que comprei ontem'), por que 買った vem ANTES de 本?"}
...
- {'pt-BR': "Ao contrário do português ('o livro que comprei'), em japonês a descrição inteira (昨日買った) vem grudada antes do substantivo (本), sem nenhuma palavra para 'que'. O verbo fica na forma simples."}


### 3. (cloze) {'pt-BR': "Complete com a condicional do resultado automático: 春になる＿桜が咲く。 ('Quando chega a primavera, as cerejeiras florescem.')"}
- **Resposta:** `{"text": "と", "full": "春になると桜が咲く"}`
- {'pt-BR': "と marca consequência automática e inevitável, perfeita para fenômenos da natureza: sempre que chega a primavera, as cerejeiras florescem. たら também caberia, mas と é a escolha clássica para esse 'sempre que A, então B'."}


### 4. (cloze) {'pt-BR': "Você reage ao plano do amigo de viajar: 日本に行く＿京都がいい。 ('Se você vai ao Japão, Kyoto é uma boa.') Qual condicional encaixa?"}
- **Resposta:** `{"text": "なら", "full": "日本に行くなら京都がいい"}`
- {'pt-BR': "なら reage a algo que o outro acabou de dizer ('se é esse o caso...'). Como você está respondendo ao plano do amigo, なら é a mais natural. Diferente de たら, não implica que a primeira ação aconteça antes da segunda."}


### 5. (sentence_build) {'pt-BR': "Monte 'Quando eu chegar em casa, vou treinar.' com as peças: [練習する] [帰ったら] [家] [に]"}
- **Resposta:** `{"order": ["家", "に", "帰ったら", "練習する"], "text": "家に帰ったら練習する。"}`
- {'pt-BR': "Condição primeiro (家に帰ったら = 'quando chegar em casa'), resultado depois (練習する = 'vou treinar'). 帰る → 帰った → 帰ったら. Como o resultado é uma decisão própria, たら funciona bem (と não aceitaria isso)."}


### 6. (production) {'pt-BR': "Diga em japonês 'a comida que meu irmão (mais velho) fez' usando 兄 (あに), 作る (つくる) na forma simples do passado, e 料理 (りょうり), nessa ordem de oração relativa."}
- **Resposta:** `{"text": "兄が作った料理", "accept": ["兄が作った料理", "あにが作った料理", "兄がつくった料理", "あにがつくった料理"]}`
- {'pt-BR': "A oração relativa (兄が作った = 'que meu irmão fez') vem antes do substantivo 料理. Dentro dela o sujeito leva が, não は, e o verbo fica na forma simples do passado (作った)."}
