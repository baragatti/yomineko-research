...
> Lição `les:n4-aspecto-06` · tópico `top:n4-aspecto` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Usar ばかり com substantivos no sentido de 'só / nada além de'
- Marcar uma ação recém-concluída com 〜たばかり ('acabar de fazer')
...
**Introduz:** gramática [bakari, ta-bakari, yatto] · vocabulário [お金持ち, そろそろ, 市民, 政治, 産業, 輸入] · kanji [—] · kana [—]
...
Um pequeno bloco de palavras sobre gente, vida em sociedade e economia, útil para falar do que se vê nos noticiários:
- お金持ち: pessoa rica, abastada.
- 市民: cidadão (de um país), cidadania.
- 政治: política, governo.
- 産業: indústria.
- 輸入: importação.
...
- Diferencio a recência de 〜たばかり do alívio de やっと.
- Reconheço 古 (velho) e 買 (comprar).
