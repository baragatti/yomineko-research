...
> Lição `les:n4-forma-simples-07` · tópico `top:n4-forma-simples` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Usar さっき para apontar um momento recente do passado na conversa
- Reagir com さすが para reconhecer que algo correspondeu à expectativa
...
**Frases (por ID, do banco dissecado):** `sent:tatoeba-182469`, `sent:tatoeba-182472`, `sent:tatoeba-10914902`, `sent:tatoeba-8533915`
...
- Sei dizer "firmemente" com しっかり na fala casual.
