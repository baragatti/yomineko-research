...
> Lição `les:n4-experiencia-02` · tópico `top:n4-experiencia` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Dizer que se passou a fazer ou a conseguir algo com 〜ようになる
- Marcar uma mudança lenta e progressiva com だんだん (aos poucos)
- Marcar uma mudança rápida e contínua com どんどん (cada vez mais)
- Ler os kanji 転・楽・研・究・着・身 em palavras de aprendizado e rotina

**Introduz:** gramática [gp-58, gp-59, you-ni-naru] · vocabulário [パソコン, 一杯, 例えば, 写す, 打つ, 玩具, 着物, 謝る, 足す, 釣る] · kanji [研 究 身] · kana [—]

**Frases (por ID, do banco dissecado):** `sent:tatoeba-189022`, `sent:tatoeba-122906`, `sent:tatoeba-10680231`, `sent:tatoeba-84062`
...
- 日本語が話せるようになった quer dizer "passei a conseguir falar japonês".
- 毎朝走るようになった quer dizer "passei a correr toda manhã".
...
"O vento foi ficando cada vez mais forte." A mesma frase com だんだん soaria como um vento que cresce devagarinho; com どんどん, ele dispara. Por isso どんどん também serve de incentivo: どんどん勉強しなさい quer dizer "estude sem parar / cada vez mais!".

> **[tip]**
Atalho de memória: だんだん lembra degraus (devagar, um a um); どんどん lembra um tambor batendo forte e rápido. O "do" pesado já lembra velocidade.

#### Vocabulário do tema
Palavras de rotina, aprendizado e progresso para usar com essas mudanças. A leitura em kana aparece no próprio cartão de cada palavra.
- 写す: copiar, transcrever. Ex.: ノートを写す, "copiar as anotações".
- 打つ: bater, digitar. Usar a パソコン com 打つ dá a ideia de teclar.
- 釣る: pescar.
- 謝る: pedir desculpas.
- 足す: somar (números).
- パソコン: computador pessoal.
- 玩具: brinquedo.
- 着物: quimono, roupa tradicional.
- 一杯: um copo / uma xícara (de).
- 例えば: por exemplo.
- 中々: bastante, consideravelmente.
...
> **[example]**
Juntando tudo: 毎日研究を続けて、日本語がだんだん分かるようになった quer dizer "continuei estudando todo dia e, aos poucos, passei a entender japonês".
...
- Reconheço os kanji 転・楽・研・究・着・身 em palavras de estudo e rotina.
...
### 7. (production) Escreva em japonês a palavra que significa quimono, a vestimenta tradicional japonesa.
...
### 8. (production) Escreva o kanji que significa estudar a fundo, pesquisar, e que também quer dizer afiar.
...
### 9. (production) Escreva o kanji que significa investigar até o fim, dominar um assunto.
...
### 10. (production) Escreva o kanji que diz o corpo e a pessoa ao mesmo tempo. Não é 体, que é só o corpo físico, nem 自, que é só a ideia de próprio.
