...
#### 〜だけで: "só com / basta"
O padrão dake-de junta だけ ("só, apenas") com a partícula で (meio). O sentido é "só com isso", "apenas por meio disso", "basta": uma condição mínima já é suficiente, sem precisar de mais nada. O molde é simples:
Molde: [verbo na forma simples] だけで [resultado]
> 🗣 見るだけで楽しい — Só de olhar já é divertido.
"Só de olhar já é divertido": o verbo 見る ("olhar") fica na forma simples e recebe だけで. A condição mínima (apenas olhar) já basta para o resultado.
> 🗣 名前を書くだけでいいです — Basta escrever o nome.
"Basta escrever o nome": aqui o molde é 書く seguido de だけで e fechado com いいです ("está bom"). O combo だけでいい é o nosso "basta (fazer) X", muito útil em instruções.
...
#### Vocabulário em ação
Esta lição traz objetos e ambientes úteis para descrever situações:
- 品物: artigo, mercadoria
- 人形: boneco
- 利用: uso, utilização
- 飾る: decorar
- 包む: embrulhar
- 会議室: sala de reuniões
- ビル: prédio
- 社長: presidente da empresa
