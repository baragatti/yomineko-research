...
> Lição `les:n4-volitivo-02` · tópico `top:n4-volitivo` · **needs_review** (Layer C, aguarda professor).
...
**Frases (por ID, do banco dissecado):** `sent:tatoeba-199355`, `sent:tatoeba-4877`, `sent:tatoeba-187786`, `sent:tatoeba-189627`
...
- Reconheço 考 ("ponderar") e 物 ("coisa").
