...
> Lição `les:n4-experiencia-06` · tópico `top:n4-experiencia` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Marcar o desfecho de um processo longo com とうとう (finalmente / por fim)
- Falar de 'quase tudo' e 'quase nada' com ほとんど (e seu par com a negação)
- Usar ずっと para 'o tempo todo' e para reforçar comparações ('muito mais')
...
- Aproximo quantidades com だいたい (mais ou menos).
- Meço grau com そんなに (tão/tanto assim).
- Formo a negação branda 〜くはない pondo は entre 〜く e ない.
...
### 3. (particle_choice) Para suavizar a negação 'não é tão ruim assim' (そう悪＿ない), qual partícula entra entre 悪く e ない?
