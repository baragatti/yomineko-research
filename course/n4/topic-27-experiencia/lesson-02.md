...
- 写す(うつす): copiar, transcrever.ノートを写す, "copiar as anotações".
- 打つ(うつ): bater, digitar.パソコン+打つ= teclar.
- 釣る(つる): pescar.
- 謝る(あやまる): pedir desculpas.
- 足す(たす): somar (números).
- パソコン(パソコン): computador pessoal.
- 玩具(おもちゃ): brinquedo.
- 着物(きもの): quimono, roupa tradicional.
- 一杯(いっぱい): um copo / uma xícara (de).
- 例えば(たとえば): por exemplo.
- 中々(なかなか): bastante, consideravelmente.
