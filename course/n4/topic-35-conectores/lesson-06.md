...
> Lição `les:n4-conectores-06` · tópico `top:n4-conectores` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Expressar contraste inesperado, surpresa ou queixa com のに ("embora", "apesar de")
- Conceder com ～ても ("mesmo que", "ainda que"), mantendo o resultado apesar da condição
- Descrever duas ações simultâneas da mesma pessoa com ～ながら ("enquanto faz")
- Indicar que um estado continua igual com まま ("do jeito que está", "sem mudar")
- Diferenciar a concessão presa ao verbo/adjetivo do contraste entre frases inteiras da lição anterior

**Introduz:** gramática [mama, nagara, noni, temo] · vocabulário [—] · kanji [—] · kana [—]

**Frases (por ID, do banco dissecado):** `sent:tatoeba-84003`, `sent:gen-fd723f8599f2`, `sent:tatoeba-83211`, `sent:tatoeba-8947014`
...
- Digo que um estado continua igual com まま ("do jeito que está").
- Diferencio essa concessão presa ao verbo do contraste entre frases inteiras (でも/しかし).
...
### 2. (cloze) Complete com a concessão 'mesmo que' a partir de 高い (caro): ＿この服を買います。; escreva só a forma de 高い + ても. (Mesmo que seja caro, vou comprar esta roupa.)
