...
> Lição `les:n4-conectores-04` · tópico `top:n4-conectores` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Usar だけでなく para dizer 'não só X (mas também Y)' e ampliar uma afirmação
...
**Frases (por ID, do banco dissecado):** `sent:tatoeba-225929`, `sent:gen-3612bfffc506`, `sent:gen-2008c11580bb`, `sent:gen-1bce6041e175`
...
O padrão gp-119 apresenta um primeiro item e sinaliza que vem mais: "não apenas X". Quase sempre a segunda parte fecha com も("também"). O molde é X だけでなく Y も.
...
- Não confundo o し (que soma) com もっとも (que contrasta).
