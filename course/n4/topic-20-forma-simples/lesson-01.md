...
> Lição `les:n4-forma-simples-01` · tópico `top:n4-forma-simples` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Marcar dúvida ou pensar em voz alta com a partícula final かな (será que...? / quem sabe)
...
**Introduz:** gramática [ka-shira, kai, kana] · vocabulário [ステレオ, テキスト, 会, 僕, 別, 大学生, 失礼, 床屋, 心配, 意見, 気, 漫画] · kanji [会 員 方 者] · kana [—]
...
- Distingo かい (pergunta ao outro) de かな/かしら (penso comigo).
