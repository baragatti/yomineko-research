# Sufixos e intensificadores: 〜代 e 真っ

> Lição `les:n4-forma-simples-06` · tópico `top:n4-forma-simples` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Formar palavras de custo com 〜代 grudando o sufixo a um substantivo de serviço ou item
...
- バス代= o dinheiro da passagem de ônibus
Veja o molde em ação. A primeira frase fala de uma despesa que não cobre o gasto; a segunda, de uma conta paga todo mês.
...
- Conheço o vocabulário novo: 運転手, 運, すっと, 非常に, 矢張り, 積もり, 若し, 伺う.
