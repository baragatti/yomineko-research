# Kanji do exame: reforço 5

> Lição `les:n4-kanji-exame-05` · tópico `top:n4-kanji-exame` · **needs_review** (Layer C, aguarda professor).
...
- Reconheço o kanji 首 e sei onde conferir suas leituras.

---

## Exercícios
### 1. (recognition) Qual destes kanji significa 'portão' e se lê もん quando aparece sozinho?
- **Resposta:** `{"choices": ["門", "間", "開", "問"], "correct": "門"}`
