...
> Lição `les:n4-aspecto-01` · tópico `top:n4-aspecto` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Formar verbos compostos de início com 〜始める ('começar a fazer') colando はじめる ao radical de outro verbo
- Marcar o início SÚBITO e involuntário de uma ação com 〜出す ('desatar a / irromper')
- Contrastar o início planejado (始める) com o início repentino (出す)
...
**Frases (por ID, do banco dissecado):** `sent:gen-1f6fd836c289`, `sent:tatoeba-228677`, `sent:tatoeba-945909`, `sent:tatoeba-8736595`
...
- Reconheço o kanji 帰 (voltar) em 帰り e 帰ってくる.
- Reconheço o kanji 音 (som).
- Sei escolher entre 始める (calmo) e 出す (repentino) conforme o clima da frase.
