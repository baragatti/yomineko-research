...
> Lição `les:n4-aspecto-03` · tópico `top:n4-aspecto` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Marcar o fim de uma ação com 〜終わる (terminar de fazer algo que tem duração)
- Usar 〜てしまう no sentido de concluir totalmente, levar a ação até o fim
...
### 3. (cloze) Complete com a CONTRAÇÃO coloquial de 飲んでしまう: ぜんぶ＿。 (Acabei bebendo tudo.)
