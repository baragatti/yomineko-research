...
> Lição `les:n4-transitividade-05` · tópico `top:n4-transitividade` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Falar de planos, prazos e preparativos com 予定, 用意, 用 e 以内
...
- Uso すっかり para dizer que algo aconteceu por completo.
- Reconheço 計 (plano/medir) e 特 (especial) em palavras do dia a dia.
