...
> Lição `les:n4-condicionais-07` · tópico `top:n4-condicionais` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Listar alternativas equivalentes com 〜でも〜でも ('tanto X quanto Y', 'seja X, seja Y')
...
**Introduz:** gramática [gp-113, gp-116, gp-133] · vocabulário [サンドイッチ, パート, 小説, 式, 畳, 親] · kanji [田] · kana [—]
