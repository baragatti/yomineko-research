...
> Lição `les:n4-oracoes-relativas-07` · tópico `top:n4-oracoes-relativas` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Comparar e dar exemplos com 〜のように／〜のような ('como / igual a')
...
- Sei escolher entre な (substantivo) e に (verbo) depois de よう.

---

## Exercícios
### 1. (recognition) Qual forma de よう vem ANTES de um substantivo, como em 夢の＿話 ('uma história de sonho')?
...
- ように depois de um verbo na forma simples (aqui o negativo 落ちない) marca finalidade: 'de modo que não caia'. A forma -ます antes de ように aparece só nos desejos e preces: 〜ますように / 〜ませんように.
- frases: `sent:tatoeba-78536`

### 4. (sentence_build) Monte 'Tem banheiro em cada andar.' com as peças: [あります] [トイレ] [各階] [が] [に]
