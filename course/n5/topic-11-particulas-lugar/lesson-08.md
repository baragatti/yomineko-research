...
> Lição `les:n5-particulas-lugar-08` · tópico `top:n5-particulas-lugar` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Ligar substantivos numa lista FECHADA com と ('A e B') e marcar companhia ('com')
...
- Marco o ponto final no tempo ou no espaço com まで ("até").
