# Onde a ação acontece: a partícula で

> Lição `les:n5-particulas-lugar-03` · tópico `top:n5-particulas-lugar` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Usar で para marcar o lugar onde uma ação acontece (estudar NA escola, comer NO restaurante)
...
**Frases (por ID, do banco dissecado):** `sent:tatoeba-778974`, `sent:tatoeba-1057336`, `sent:tatoeba-125387`, `sent:tatoeba-195443`
...
- Reconheço o kanji 生 (vida/nascimento) em 学生 e 先生.
