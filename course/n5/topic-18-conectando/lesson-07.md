...
Molde: 読んだり 休んだり する (= "fico fazendo coisas como ler e descansar").
...
## Exercícios
### 1. (recognition) O que a estrutura ～たり～たりする comunica numa frase como 読んだり休んだりします？
...
- ～たり～たりする lista exemplos sem fechar a lista: 'fazer coisas como A e B (entre outras)'. Não é uma lista exaustiva nem uma sequência fixa.


### 2. (cloze) Complete com a estrutura de lista. 日曜日は本を読＿休んだりします。 (No domingo leio livros, descanso etc.)
- **Resposta:** `{"text": "んだり", "full": "日曜日は本を読んだり休んだりします"}`
- Do passado casual 読んだ tira-se 読んだり. O たり precisa aparecer em CADA item (読んだり e 休んだり), e a frase fecha com します.


### 3. (recognition) 読み方（よみかた）quer dizer o quê?
- **Resposta:** `{"choices": ["a maneira de ler / como se lê", "o livro de leitura", "ler em voz alta"], "correct": "a maneira de ler / como se lê"}`
- 方（かた）gruda na raiz do verbo (読み, de 読む) e cria o substantivo 'o modo de'. Logo 読み方 = 'a maneira de ler'. O kanji 読 (ler) está bem ali no começo.


### 4. (sentence_build) Monte 'Qual é a leitura deste kanji?' com as peças: [読み方] [何] [か] [この] [は] [漢字] [の] [です]
- **Resposta:** `{"order": ["この", "漢字", "の", "読み方", "は", "何", "です", "か"], "text": "この漢字の読み方は何ですか。"}`
- A ideia central é 読み方 (a maneira de ler) como substantivo: この漢字の読み方 = 'a leitura deste kanji'. Encaixe 何 ('o quê') antes de です para perguntar qual é essa leitura.


### 5. (production) Diga em japonês 'Aos sábados eu faço coisas como ler livros e descansar.' usando 本 (livro), 読む (ler), 休む (descansar) na estrutura ～たり～たりする (forma educada no fim).
