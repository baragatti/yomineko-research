...
### 4. (sentence_build) Monte 'Como se lê este kanji?' com as peças: [読み方] [か] [この] [は] [漢字] [です]
- **Resposta:** `{"order": ["この", "漢字", "の", "読み方", "は", "です", "か"], "text": "この漢字の読み方は何ですか。"}`
- 💡 A ideia central é 読み方 (a maneira de ler) como substantivo: この漢字の読み方 = 'a maneira de ler deste kanji'. ⚠ Na prática se acrescenta 何 ('o quê') antes de です; aqui o foco é encaixar 読み方 como núcleo nominal.
