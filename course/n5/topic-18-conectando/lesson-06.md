...
A estrutura tsumori declara um plano que você já decidiu: "pretendo (fazer)", "tenho a intenção de". É mais firme do que um plano vago. Use o verbo na forma de dicionário +つもり+です.
- 来年旅行するつもりです= "pretendo viajar 来年".
- 来週料理を習うつもりです= "pretendo aprender 料理来週" (習う = aprender).

> **[l1-pitfall]**
Para dizer que você não pretende fazer algo, ponha o verbo no negativo curto +つもり:行かないつもりです= "pretendo não ir". Não diga 「行くつもりじゃない」 para isso; o negativo vai no verbo, não no つもり.

#### Experiência de vida: verbo た + ことがある
A estrutura ta-koto-ga-aru fala do seu repertório de experiências: "já fiz isso pelo menos uma vez". Equivale ao nosso "já + verbo". Use o verbo no passado curto (a forma た) +ことがあります.
- 日本へ行ったことがあります= "já fui ao Japão".
- その料理を食べたことがあります= "já comi essa comida".

> **[tip]**
Para dizer que você nunca fez algo, deixe o verbo no passado e negue o final:雪を見たことがありません= "nunca vi neve". O た continua no verbo; quem fica negativo é o あります→ありません.
...
> **[l1-pitfall]**
O tempo do verbo antes de とき muda o sentido.寝るとき(dicionário) = "na hora de dormir / antes de dormir";寝たとき(passado) = "depois de já ter dormido". Pense no que ainda não terminou (dicionário) versus o que já terminou (た).

#### Dois verbos novos para essas frases
Aproveite para guardar dois verbos muito úteis com estas estruturas:分かる(わかる, "entender, compreender") e 忘れる(わすれる, "esquecer").
- 練習のとき、よく分かりました= "na hora do 練習, entendi bem".
- 名前を忘れたことがあります= "já esqueci o nome (de alguém)".

#### Kanji do dia: 父
O kanji 父 significa "pai". Tem duas leituras úteis:ちち(o meu próprio pai, ao falar dele com outras pessoas) e とう em お父さん("pai", forma respeitosa, e como você se dirige ao seu pai ou fala do pai dos outros).
