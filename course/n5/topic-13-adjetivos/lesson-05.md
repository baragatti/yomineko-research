...
> Lição `les:n5-adjetivos-05` · tópico `top:n5-adjetivos` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Formar o advérbio ～く a partir do adjetivo-い (速い → 速く) para descrever como uma ação acontece
...
- あと= "atrás / depois" (後).
- さき= "ponta / mais à frente" (先).
- いま= "agora" (今).
- じ= "hora(s)", ao marcar o horário (時).
- あさって= "depois de amanhã" (明後日).
- いっしょ= "(fazer) juntos" (一緒).
- おとな= "adulto" (大人);大人になる= "virar adulto".
- おおぜい= "multidão, muita gente" (大勢).
...
- Uso ～くなる com adjetivos-い e não coloco に antes.
- Reconheço o kanji 来 (vir / tornar-se).
- Reconheço os kanji 外 (fora), 下 (abaixo) e 気 (ânimo).
