...
- Molde: [verbo na forma de dicionário] の が へたです
...
## Exercícios
### 1. (recognition) Qual palavra significa 'ruim / sem jeito' em uma atividade (o oposto de じょうず)?
- **Resposta:** `{"choices": ["へた", "じょうず", "すき"], "correct": "へた"}`
- へた (下手) é o adjetivo-な que significa 'ruim em algo, sem jeito'. É o oposto exato de じょうず (上手, 'bom em'). すき é 'gostar de'.


### 2. (particle_choice) Complete: 料理をするの＿下手です。 (Sou ruim em cozinhar.)
- **Resposta:** `{"choices": ["が", "を", "に"], "correct": "が"}`
- A atividade nominalizada por の é marcada por が, a mesma partícula de じょうず e すき. Literalmente: 'o ato de cozinhar é ruim (pra mim)'. Não se usa を nem に aqui.


### 3. (cloze) Complete com a palavra que indica POUCA habilidade: 歌を歌うのが＿です。 (Sou ruim em cantar.)
- **Resposta:** `{"text": "下手", "full": "歌を歌うのが下手です"}`
- 下手 (へた) = 'ruim, sem jeito'. O molde é [verbo] + の + が + 下手です. Se quisesse dizer 'sou bom em cantar', trocaria por 上手 (じょうず).


### 4. (sentence_build) Monte 'Sou ruim em cozinhar.' com as peças: [下手] [料理] [が] [する] [の] [です] [を]
- **Resposta:** `{"order": ["料理", "を", "する", "の", "が", "下手", "です"], "text": "料理をするのが下手です。"}`
- 料理を (objeto) + する (fazer) + の (nominaliza: 'o ato de fazer') + が (marca a atividade) + 下手です (é ruim). O verbo fica na forma de dicionário antes do の.
