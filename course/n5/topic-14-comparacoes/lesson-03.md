# Escolher e sugerir: ～にする e ～はどうですか

> Lição `les:n5-comparacoes-03` · tópico `top:n5-comparacoes` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Escolher entre alternativas com 〜にする ('vou de.../fico com...')
...
- Reconheço e leio o kanji 女 (おんな, "mulher").
