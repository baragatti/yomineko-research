...
> Lição `les:n5-comparacoes-01` · tópico `top:n5-comparacoes` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Dizer que A é mais [adjetivo] que B usando より ('do que') e ～のほうが ('o lado de...')
- Reconhecer que より gruda no termo MENOR (o 'do que') e que não existe um 'mais' avulso
...
> **[tip]**
Estas palavrinhas não são adjetivos-い, mas ajudam a temperar a comparação e a falar sobre o que se compara. Vale guardá-las aos poucos:
- 大変: muito, terrivelmente.
- 沢山: um monte.
- 多分: provavelmente.
- 茶色: marrom.
- 次: o próximo.
...
- Uso より…のほうが para dizer "B é mais / prefiro B".
