...
> Lição `les:n5-comparacoes-06` · tópico `top:n5-comparacoes` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Formar ～すぎる a partir de verbos (raiz da forma ます) e de adjetivos (sem o い / sem o な)
- Indicar excesso em uma AÇÃO (comer demais, beber demais) com 〜すぎる
- Indicar uma qualidade EXAGERADA (caro demais, grande demais) com 〜すぎる
- Distinguir すぎる (exagero indesejado) de とても ("muito", neutro)
...
- Sei que 七日 se lê なのか (irregular) e significa "dia 7 / sete dias".
- Não confundo すぎる (exagero, com tom de problema) com とても ("muito", neutro).
