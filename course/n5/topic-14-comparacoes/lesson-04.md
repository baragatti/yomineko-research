...
> Lição `les:n5-comparacoes-04` · tópico `top:n5-comparacoes` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Dizer que se quer ter uma coisa (objeto, animal, item) com o molde Substantivo が ほしい(です)
...
Molde da pergunta: [coisa] が ほしい です か
...
- Reconheço os kanji 七, 百, 北 e 午 e sei pelo menos uma leitura de cada.
