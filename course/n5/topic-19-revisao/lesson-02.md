# Revisão N5; Verbos, adjetivos e lugar/tempo

> Lição `les:n5-revisao-02` · tópico `top:n5-revisao` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Conjugar verbos na forma polida no presente, passado, negativo e passado-negativo (〜ます／〜ません／〜ました／〜ませんでした)
- Flexionar adjetivos-い e adjetivos-な no presente, negativo e passado
- Escolher corretamente entre に, へ e で para lugar, direção, destino, tempo e local da ação
- Recombinar números, contadores e horas em frases completas
...
### Revisão N5: verbos, adjetivos e as partículas de lugar e tempo
...
- Sei que o adjetivo-い vira 〜かった no passado (não 〜いでした), e que o adjetivo-な muda o です para でした.
- Lembro que いい é exceção: よかった, よくない.
- Escolho に para destino/existência/hora, へ para direção e で para o local da ação.
- Monto uma frase juntando hora, contador, partícula e verbo na ordem certa.
