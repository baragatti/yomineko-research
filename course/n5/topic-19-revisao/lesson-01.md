...
> Lição `les:n5-revisao-01` · tópico `top:n5-revisao` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Ler hiragana e katakana com fluência, lembrando que は・へ・を como partículas mudam de som
- Usar a cópula です／だ nas formas afirmativa, negativa (じゃない) e passada (でした)
- Escolher entre これ系 (これ・それ・あれ) e この系 (この・その・あの) conforme a distância e o uso
- Reconhecer e aplicar as partículas básicas は・が・を・の・も・か
...
- Uso です／だ no afirmativo, no negativo (じゃない) e no passado (でした).
- Escolho entre これ系 e この系 conforme a distância e se há substantivo depois.
- Aplico as partículas は・が・を・の・も・か no lugar certo, sempre depois da palavra.
