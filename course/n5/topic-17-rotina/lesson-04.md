...
> Lição `les:n5-rotina-04` · tópico `top:n5-rotina` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Montar a forma 〜たり a partir do passado casual do verbo (trocar た/だ por たり/だり)
- Encadear duas ou mais atividades-exemplo com 〜たり〜たり sem implicar lista fechada nem ordem fixa
- Fechar a estrutura com する para dar tempo e polidez à frase inteira
- Ler e reconhecer os kanji 白 (branco) e 天 (céu)

**Introduz:** gramática [gp-143, gp-144, tari-tari] · vocabulário [燐寸, 眼鏡] · kanji [白] · kana [—]
...
- 眼鏡(メガネ) = óculos.
- 燐寸(マッチ) = fósforo (para acender fogo).
- 南(みなみ) = sul.
...
- Reconheço o kanji 白 (branco) e suas leituras しろ / 白い / ハク.
- Reconheço o kanji 天 (céu) e a leitura テン em 天気.
...
### 7. (recognition) Qual destes kanji significa "branco"?
...
### 8. (production) Escreva em japonês, com kanji, o adjetivo que significa "branco" e se lê しろい.
