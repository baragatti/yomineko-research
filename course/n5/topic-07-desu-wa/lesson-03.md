# Perguntar e negar: か e じゃない

> Lição `les:n5-desu-wa-03` · tópico `top:n5-desu-wa` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Transformar uma afirmação em pergunta sim/não acrescentando か no fim
