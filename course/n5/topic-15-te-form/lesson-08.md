# Obrigação na fala: as contrações 〜なくちゃ・〜なきゃ

> Lição `les:n5-te-form-08` · tópico `top:n5-te-form` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Reconhecer 〜なくちゃいけない como a forma falada de 〜なくてはいけない
- Usar as contrações curtas 〜なくちゃ e 〜なきゃ deixando o '…não dá' subentendido
- Ler em kana o vocabulário de números, idade e datas (oito, 20 anos, dia 20, um/uma)

**Introduz:** gramática [gp-145, gp-52, nakucha] · vocabulário [一つ, 一人, 一月, 八, 平仮名, ２０日, ２０歳] · kanji [男] · kana [—]

**Frases (por ID, do banco dissecado):** `sent:tatoeba-8753239`, `sent:tatoeba-8736593`, `sent:tatoeba-528350`
...
- 八(はち) = oito;一つ(ひとつ) = um/uma.
- ２０歳(はたち) = 20 anos de idade, uma leitura especial;２０日(はつか) = dia 20 do mês.
...
- Leio em kana o vocabulário de número, idade e data (はち, はたち, はつか).
...
### 3. (cloze) Encurte para a forma falada com いけない: 行かなくては＿＿＿けない → 行か＿＿＿いけない. Escreva o que entra no lugar de なくては.
