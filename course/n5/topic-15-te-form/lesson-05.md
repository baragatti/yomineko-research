# Pode e não pode: permissão e proibição (forma polida)

> Lição `les:n5-te-form-05` · tópico `top:n5-te-form` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Pedir e conceder permissão com 〜てもいいです(か)
...
**Frases (por ID, do banco dissecado):** `sent:tatoeba-13158601`, `sent:tatoeba-2242416`, `sent:tatoeba-4147428`, `sent:tatoeba-10962356`

---

### Pode e não pode: dando licença e impondo regras
...
- Distingo os verbos ひく 弾く (tocar) e 引く (puxar) pelo kanji.
