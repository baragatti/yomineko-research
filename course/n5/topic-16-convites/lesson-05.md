...
> Lição `les:n5-convites-05` · tópico `top:n5-convites` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Falar de rotina com a família 毎 (毎朝, 毎日, 毎週, 毎月, 毎年, 毎晩)
...
- 分(ふん) = "minuto", a unidade de tempo. É o "min" do relógio.
...
- Conto objetos genéricos com 二つ (ふたつ).
- Conto pessoas com 二人 (ふたり).
- Uso 枚 (まい) para objetos finos e planos (folhas, ingressos, pratos).
