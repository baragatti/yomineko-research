...
> Lição `les:n5-numeros-tempo-01` · tópico `top:n5-numeros-tempo` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Ler em voz alta os algarismos de 1 a 10 na leitura on (estilo contagem)
...
- 9 =きゅう: "kyuu", com o som kyu segurado por dois tempos (duas palmas), não falado mais forte. O きゅ é um golpe só; é o う no fim que estica a vogal.
...
- Reconheço e escrevo os kanji 一, 二 e 十.
- Não confundo mais 4 (し), 7 (しち) e 9 (きゅう).
