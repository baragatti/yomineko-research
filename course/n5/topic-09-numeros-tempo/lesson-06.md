# Mesa, cozinha e temperos

> Lição `les:n5-numeros-tempo-06` · tópico `top:n5-numeros-tempo` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Nomear comidas e temperos básicos da cozinha japonesa (arroz, peixe, sal, açúcar, shoyu)
- Nomear utensílios de mesa (copo, colher) e o refeitório (食堂)
- Aplicar números e contadores já vistos a comidas e utensílios do dia a dia

**Introduz:** gramática [—] · vocabulário [ご飯, スプーン, 口, 塩, 洋杯, 砂糖, 醤油, 食堂, 魚] · kanji [—] · kana [—]
...
- Nomeio os utensílios コップ (copo) e スプーン (colher).
- Reconheço 食堂 (refeitório) e 口 (boca).
