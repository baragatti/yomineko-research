...
> Lição `les:n5-passado-03` · tópico `top:n5-passado` · **needs_review** (Layer C, aguarda professor).

**Objetivos:**
- Usar ね no fim da frase para buscar concordância e suavizar a fala (como o nosso 'né?')
- Usar よ no fim da frase para afirmar com convicção ou avisar de algo que o outro não sabe
...
**Frases (por ID, do banco dissecado):** `sent:tatoeba-13063899`, `sent:tatoeba-200577`, `sent:tatoeba-8608115`, `sent:tatoeba-11532911`
...
A partícula ne vai no fim da frase para pedir a concordância ou a confirmação da outra pessoa, igualzinho ao nosso né? (aquela marca que você cola no fim para checar se o outro pensa o mesmo). Você usa ね quando pressupõe que a outra pessoa concorda e só quer aquele aceno de cabeça.
...
> 🗣 大きいね。 — É grande, né?
Aqui 大きい quer dizer "grande", e o ね no fim transforma a constatação num convite à concordância: "é grande, né?". Sem o ね, seria só uma afirmação seca.
...
> **[tip]**
Regra de bolso: se vocês dois já sabem e você só quer o "né?", use ね. Se a informação é sua e o outro talvez não saiba, use よ. Em uma frase: ね = a gente concorda; よ = eu te conto.
...
Aqui 後で é "depois" e 話そう é "vamos conversar". O ね no fim deixa o convite gentil, buscando o "tá?" do outro, em vez de soar como uma ordem.

#### Vocabulário: a casa e o estudo
Objetos que você tem por perto, ótimos para treinar ね e よ apontando para as coisas:
- 机: escrivaninha, carteira escolar
- テーブル: mesa
- 茶碗: tigela de arroz, xícara de chá
- 時計: relógio
- テープ: fita
- テレビ: televisão
- テスト: teste, prova
- 手紙: carta, bilhete
- 電気: eletricidade, luz (a lâmpada, a iluminação)
...
#### Mais exemplos
> 🗣 わがままね。 — Você é egoísta, né.
> 🗣 とても大きいね。 — É bem grande, né?
- Uso ね no fim da frase para pedir concordância (como "né?").
- Uso よ no fim da frase para avisar ou afirmar uma informação nova.
- Sei escolher entre ね (a gente concorda) e よ (eu te conto).
- Reconheço o kanji 今 e sei que significa "agora" (いま).
