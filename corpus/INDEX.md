...
_Generated 2026-06-17 from `db/corpus.sqlite` (regenerable index). **These JSON/MD files are the source of truth.** Localized content uses locale-objects keyed by `pt-BR` (+ `en` source); mechanical enums are neutral. See `design/i18n.md`._
...
| sentences | `corpus/sentences/bank.json` | 4958 | (dissected) |
