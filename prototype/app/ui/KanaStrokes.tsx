...
/* Kana stroke-order viewer. Data = our adaptation of strokesvg (Klee One SIL OFL + MIT): clean per-stroke
   centerlines, drawn sequentially with a stroke-dashoffset "pen" animation. A faint ghost shows the full kana. */
