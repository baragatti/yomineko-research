# Revisão — Trilha Fala Primeiro · Fala Primeiro
...
## 1. `speak:arrival-01` — Chegar e cumprimentar, parte 1

- **Etapa:** `speak:arrival` · unidade 1
- **Onde entra no curso:** etapa 1 — Chegar e cumprimentar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim

<details><summary>Contexto (não é alvo de parecer)</summary>

- `sent:tatoeba-1598216` おはよう。 — Bom dia.
- `sent:tatoeba-373351` こんにちは。 — Boa tarde.
- `sent:tatoeba-1532832` ありがとう。 — Obrigado.
- `sent:tatoeba-426889` さようなら！ — Tchau!
- `sent:tatoeba-408301` すみません。 — Desculpe.
- `sent:tatoeba-335372` おはようございます。 — Bom dia!

</details>

### `title@pt-BR` · camada C · hash `d5d29f3f25c025f7`
...
## 2. `speak:arrival-02` — Chegar e cumprimentar, parte 2

- **Etapa:** `speak:arrival` · unidade 2
- **Onde entra no curso:** etapa 1 — Chegar e cumprimentar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `fd52072ec962c096`
...
## 3. `speak:arrival-03` — Chegar e cumprimentar, parte 3

- **Etapa:** `speak:arrival` · unidade 3
- **Onde entra no curso:** etapa 1 — Chegar e cumprimentar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `ab9ea238a4dd9aa9`
...
## 4. `speak:arrival-04` — Chegar e cumprimentar, parte 4

- **Etapa:** `speak:arrival` · unidade 4
- **Onde entra no curso:** etapa 1 — Chegar e cumprimentar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `f862cc9424b3df71`
...
## 5. `speak:arrival-05` — Chegar e cumprimentar, parte 5

- **Etapa:** `speak:arrival` · unidade 5
- **Onde entra no curso:** etapa 1 — Chegar e cumprimentar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `2daeb5289dff8d2a`
...
## 6. `speak:arrival-06` — Chegar e cumprimentar, parte 6

- **Etapa:** `speak:arrival` · unidade 6
- **Onde entra no curso:** etapa 1 — Chegar e cumprimentar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `55ceadcda09c72df`
...
## 7. `speak:shopping-01` — Isto, aquilo, quanto custa, parte 1

- **Etapa:** `speak:shopping` · unidade 1
- **Onde entra no curso:** etapa 2 — Isto, aquilo, quanto custa (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `b3e89867fce6bc54`
...
## 8. `speak:shopping-02` — Isto, aquilo, quanto custa, parte 2

- **Etapa:** `speak:shopping` · unidade 2
- **Onde entra no curso:** etapa 2 — Isto, aquilo, quanto custa (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `c10f559291177825`
...
## 9. `speak:shopping-03` — Isto, aquilo, quanto custa, parte 3

- **Etapa:** `speak:shopping` · unidade 3
- **Onde entra no curso:** etapa 2 — Isto, aquilo, quanto custa (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `ae35f234f79aef61`
...
## 10. `speak:shopping-04` — Isto, aquilo, quanto custa, parte 4

- **Etapa:** `speak:shopping` · unidade 4
- **Onde entra no curso:** etapa 2 — Isto, aquilo, quanto custa (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `bbd31c53d89f7266`
...
## 11. `speak:shopping-05` — Isto, aquilo, quanto custa, parte 5

- **Etapa:** `speak:shopping` · unidade 5
- **Onde entra no curso:** etapa 2 — Isto, aquilo, quanto custa (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `62ae89d2f84e61e3`
...
## 12. `speak:shopping-06` — Isto, aquilo, quanto custa, parte 6

- **Etapa:** `speak:shopping` · unidade 6
- **Onde entra no curso:** etapa 2 — Isto, aquilo, quanto custa (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `c70c1350881cb3ee`
...
## 13. `speak:eating-01` — Comer e beber fora, parte 1

- **Etapa:** `speak:eating` · unidade 1
- **Onde entra no curso:** etapa 3 — Comer e beber fora (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `c02d1f584684b722`
...
## 14. `speak:eating-02` — Comer e beber fora, parte 2

- **Etapa:** `speak:eating` · unidade 2
- **Onde entra no curso:** etapa 3 — Comer e beber fora (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `c8fc2f02be797b65`
...
## 15. `speak:eating-03` — Comer e beber fora, parte 3

- **Etapa:** `speak:eating` · unidade 3
- **Onde entra no curso:** etapa 3 — Comer e beber fora (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `dc83a30688fa49ac`
...
## 16. `speak:eating-04` — Comer e beber fora, parte 4

- **Etapa:** `speak:eating` · unidade 4
- **Onde entra no curso:** etapa 3 — Comer e beber fora (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `6bf06b5df14e9065`
...
## 17. `speak:eating-05` — Comer e beber fora, parte 5

- **Etapa:** `speak:eating` · unidade 5
- **Onde entra no curso:** etapa 3 — Comer e beber fora (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `287bb40d2a7fdab8`
...
## 18. `speak:eating-06` — Comer e beber fora, parte 6

- **Etapa:** `speak:eating` · unidade 6
- **Onde entra no curso:** etapa 3 — Comer e beber fora (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `e524260bf73bba05`
...
## 19. `speak:getting_around-01` — Chegar aonde você quer, parte 1

- **Etapa:** `speak:getting_around` · unidade 1
- **Onde entra no curso:** etapa 4 — Chegar aonde você quer (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `20e0eb0f43a26b41`
...
## 20. `speak:getting_around-02` — Chegar aonde você quer, parte 2

- **Etapa:** `speak:getting_around` · unidade 2
- **Onde entra no curso:** etapa 4 — Chegar aonde você quer (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `32322b8ad898ca8e`
...
## 21. `speak:getting_around-03` — Chegar aonde você quer, parte 3

- **Etapa:** `speak:getting_around` · unidade 3
- **Onde entra no curso:** etapa 4 — Chegar aonde você quer (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `a6fe057bbb9c65d0`
...
## 22. `speak:getting_around-04` — Chegar aonde você quer, parte 4

- **Etapa:** `speak:getting_around` · unidade 4
- **Onde entra no curso:** etapa 4 — Chegar aonde você quer (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `9ab7d7e986062a69`
...
## 23. `speak:getting_around-05` — Chegar aonde você quer, parte 5

- **Etapa:** `speak:getting_around` · unidade 5
- **Onde entra no curso:** etapa 4 — Chegar aonde você quer (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `94ffb78655f59157`
...
## 24. `speak:getting_around-06` — Chegar aonde você quer, parte 6

- **Etapa:** `speak:getting_around` · unidade 6
- **Onde entra no curso:** etapa 4 — Chegar aonde você quer (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `09d47c4580ccf085`
...
## 25. `speak:lodging-01` — Dormir e resolver problemas, parte 1

- **Etapa:** `speak:lodging` · unidade 1
- **Onde entra no curso:** etapa 5 — Dormir e resolver problemas (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `5dfb825ea87ece63`
...
## 26. `speak:lodging-02` — Dormir e resolver problemas, parte 2

- **Etapa:** `speak:lodging` · unidade 2
- **Onde entra no curso:** etapa 5 — Dormir e resolver problemas (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `d81caa588dbc1771`
...
## 27. `speak:lodging-03` — Dormir e resolver problemas, parte 3

- **Etapa:** `speak:lodging` · unidade 3
- **Onde entra no curso:** etapa 5 — Dormir e resolver problemas (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `5cb01425ddd26d27`
...
## 28. `speak:lodging-04` — Dormir e resolver problemas, parte 4

- **Etapa:** `speak:lodging` · unidade 4
- **Onde entra no curso:** etapa 5 — Dormir e resolver problemas (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `284fe71c7203f796`
...
## 29. `speak:lodging-05` — Dormir e resolver problemas, parte 5

- **Etapa:** `speak:lodging` · unidade 5
- **Onde entra no curso:** etapa 5 — Dormir e resolver problemas (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `50269e0206ae1985`
...
## 30. `speak:lodging-06` — Dormir e resolver problemas, parte 6

- **Etapa:** `speak:lodging` · unidade 6
- **Onde entra no curso:** etapa 5 — Dormir e resolver problemas (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `680e4e1df7ea6904`
...
## 31. `speak:about_you-01` — Falar de você, parte 1

- **Etapa:** `speak:about_you` · unidade 1
- **Onde entra no curso:** etapa 6 — Falar de você (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `22a2dcda8982fb22`
...
## 32. `speak:about_you-02` — Falar de você, parte 2

- **Etapa:** `speak:about_you` · unidade 2
- **Onde entra no curso:** etapa 6 — Falar de você (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `0bdff3169bf0cc40`
...
## 33. `speak:about_you-03` — Falar de você, parte 3

- **Etapa:** `speak:about_you` · unidade 3
- **Onde entra no curso:** etapa 6 — Falar de você (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `605f7f6daa25a1ba`
...
## 34. `speak:about_you-04` — Falar de você, parte 4

- **Etapa:** `speak:about_you` · unidade 4
- **Onde entra no curso:** etapa 6 — Falar de você (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `84b26a1a77002866`
...
## 35. `speak:about_you-05` — Falar de você, parte 5

- **Etapa:** `speak:about_you` · unidade 5
- **Onde entra no curso:** etapa 6 — Falar de você (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `5fc08ce6e57006fd`
...
## 36. `speak:about_you-06` — Falar de você, parte 6

- **Etapa:** `speak:about_you` · unidade 6
- **Onde entra no curso:** etapa 6 — Falar de você (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `07a91be1ba72e593`
...
## 37. `speak:time_plans-01` — Quando, que horas, combinar, parte 1

- **Etapa:** `speak:time_plans` · unidade 1
- **Onde entra no curso:** etapa 7 — Quando, que horas, combinar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `aa326dc71100bcba`
...
## 38. `speak:time_plans-02` — Quando, que horas, combinar, parte 2

- **Etapa:** `speak:time_plans` · unidade 2
- **Onde entra no curso:** etapa 7 — Quando, que horas, combinar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `8f261a45e3e31193`
...
## 39. `speak:time_plans-03` — Quando, que horas, combinar, parte 3

- **Etapa:** `speak:time_plans` · unidade 3
- **Onde entra no curso:** etapa 7 — Quando, que horas, combinar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `6a0f24e587ae497f`
...
## 40. `speak:time_plans-04` — Quando, que horas, combinar, parte 4

- **Etapa:** `speak:time_plans` · unidade 4
- **Onde entra no curso:** etapa 7 — Quando, que horas, combinar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `667a61bf3601753f`
...
## 41. `speak:time_plans-05` — Quando, que horas, combinar, parte 5

- **Etapa:** `speak:time_plans` · unidade 5
- **Onde entra no curso:** etapa 7 — Quando, que horas, combinar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `4aa1b2cc0ff0cb21`
...
## 42. `speak:time_plans-06` — Quando, que horas, combinar, parte 6

- **Etapa:** `speak:time_plans` · unidade 6
- **Onde entra no curso:** etapa 7 — Quando, que horas, combinar (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `f62fa4439a28d72d`
...
## 43. `speak:health-01` — Emergência e saúde, parte 1

- **Etapa:** `speak:health` · unidade 1
- **Onde entra no curso:** etapa 8 — Emergência e saúde (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `63455634614997cb`
...
## 44. `speak:health-02` — Emergência e saúde, parte 2

- **Etapa:** `speak:health` · unidade 2
- **Onde entra no curso:** etapa 8 — Emergência e saúde (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `841a0d5a64e3bda4`
...
## 45. `speak:health-03` — Emergência e saúde, parte 3

- **Etapa:** `speak:health` · unidade 3
- **Onde entra no curso:** etapa 8 — Emergência e saúde (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `93d5d784f19018ba`
...
## 46. `speak:health-04` — Emergência e saúde, parte 4

- **Etapa:** `speak:health` · unidade 4
- **Onde entra no curso:** etapa 8 — Emergência e saúde (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `ebfbc43d04b0974f`
...
## 47. `speak:health-05` — Emergência e saúde, parte 5

- **Etapa:** `speak:health` · unidade 5
- **Onde entra no curso:** etapa 8 — Emergência e saúde (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `68c050600468e8ff`
...
## 48. `speak:health-06` — Emergência e saúde, parte 6

- **Etapa:** `speak:health` · unidade 6
- **Onde entra no curso:** etapa 8 — Emergência e saúde (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `99d4c9f099e1aa10`
...
## 49. `speak:past_stories-01` — Contar o que aconteceu, parte 1

- **Etapa:** `speak:past_stories` · unidade 1
- **Onde entra no curso:** etapa 9 — Contar o que aconteceu (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `3f350cdb8c9825f7`
...
## 50. `speak:past_stories-02` — Contar o que aconteceu, parte 2

- **Etapa:** `speak:past_stories` · unidade 2
- **Onde entra no curso:** etapa 9 — Contar o que aconteceu (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `425063962e0df042`
...
## 51. `speak:past_stories-03` — Contar o que aconteceu, parte 3

- **Etapa:** `speak:past_stories` · unidade 3
- **Onde entra no curso:** etapa 9 — Contar o que aconteceu (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `0c4edf6c2159aaf7`
...
## 52. `speak:past_stories-04` — Contar o que aconteceu, parte 4

- **Etapa:** `speak:past_stories` · unidade 4
- **Onde entra no curso:** etapa 9 — Contar o que aconteceu (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `5eb756ddc878966f`
...
## 53. `speak:past_stories-05` — Contar o que aconteceu, parte 5

- **Etapa:** `speak:past_stories` · unidade 5
- **Onde entra no curso:** etapa 9 — Contar o que aconteceu (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `2327f620b0b812b9`
...
## 54. `speak:past_stories-06` — Contar o que aconteceu, parte 6

- **Etapa:** `speak:past_stories` · unidade 6
- **Onde entra no curso:** etapa 9 — Contar o que aconteceu (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `8ac19176f3b33689`
...
## 55. `speak:politeness-01` — Pedir, oferecer, agradecer com jeito, parte 1

- **Etapa:** `speak:politeness` · unidade 1
...
### `title@pt-BR` · camada C · hash `2fc39000f91814e8`
...
## 56. `speak:politeness-02` — Pedir, oferecer, agradecer com jeito, parte 2

- **Etapa:** `speak:politeness` · unidade 2
- **Onde entra no curso:** etapa 10 — Pedir, oferecer, agradecer com jeito (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `9b25d8de320624de`
...
## 57. `speak:politeness-03` — Pedir, oferecer, agradecer com jeito, parte 3

- **Etapa:** `speak:politeness` · unidade 3
- **Onde entra no curso:** etapa 10 — Pedir, oferecer, agradecer com jeito (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `8e0ef923605be476`
...
## 60. `speak:politeness-06` — Pedir, oferecer, agradecer com jeito, parte 6

- **Etapa:** `speak:politeness` · unidade 6
- **Onde entra no curso:** etapa 10 — Pedir, oferecer, agradecer com jeito (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `11cbb0caf254366e`
...
## 61. `speak:opinions-01` — Dizer o que você acha, parte 1

- **Etapa:** `speak:opinions` · unidade 1
- **Onde entra no curso:** etapa 11 — Dizer o que você acha (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `30586b6edb1f5683`
...
## 62. `speak:opinions-02` — Dizer o que você acha, parte 2

- **Etapa:** `speak:opinions` · unidade 2
- **Onde entra no curso:** etapa 11 — Dizer o que você acha (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `e409a5a6a80d3503`
...
## 63. `speak:opinions-03` — Dizer o que você acha, parte 3

- **Etapa:** `speak:opinions` · unidade 3
- **Onde entra no curso:** etapa 11 — Dizer o que você acha (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `4a5eb9327c515787`
...
## 64. `speak:opinions-04` — Dizer o que você acha, parte 4

- **Etapa:** `speak:opinions` · unidade 4
- **Onde entra no curso:** etapa 11 — Dizer o que você acha (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `b059a9af5e748006`
...
## 65. `speak:opinions-05` — Dizer o que você acha, parte 5

- **Etapa:** `speak:opinions` · unidade 5
- **Onde entra no curso:** etapa 11 — Dizer o que você acha (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `950816c4a80a01d5`
...
## 66. `speak:opinions-06` — Dizer o que você acha, parte 6

- **Etapa:** `speak:opinions` · unidade 6
- **Onde entra no curso:** etapa 11 — Dizer o que você acha (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `e405ffee93cd1e83`
...
## 67. `speak:real_talk-01` — Conversa de verdade, parte 1

- **Etapa:** `speak:real_talk` · unidade 1
- **Onde entra no curso:** etapa 12 — Conversa de verdade (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `7744b733bbf144f6`
...
## 68. `speak:real_talk-02` — Conversa de verdade, parte 2

- **Etapa:** `speak:real_talk` · unidade 2
- **Onde entra no curso:** etapa 12 — Conversa de verdade (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `b33d10565ad0a19a`
...
## 69. `speak:real_talk-03` — Conversa de verdade, parte 3

- **Etapa:** `speak:real_talk` · unidade 3
- **Onde entra no curso:** etapa 12 — Conversa de verdade (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `ad960731f28717ac`
...
## 70. `speak:real_talk-04` — Conversa de verdade, parte 4

- **Etapa:** `speak:real_talk` · unidade 4
- **Onde entra no curso:** etapa 12 — Conversa de verdade (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `005506c1bbc737f3`
...
## 71. `speak:real_talk-05` — Conversa de verdade, parte 5

- **Etapa:** `speak:real_talk` · unidade 5
- **Onde entra no curso:** etapa 12 — Conversa de verdade (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `df44d427185c39c7`
...
## 72. `speak:real_talk-06` — Conversa de verdade, parte 6

- **Etapa:** `speak:real_talk` · unidade 6
- **Onde entra no curso:** etapa 12 — Conversa de verdade (trilha Fala Primeiro, ordenação própria)
- **Precisa de revisão (`needs_review`):** sim
...
### `title@pt-BR` · camada C · hash `042728f4cc7430fd`
