...
| 7 | W13b | derive glosses (done: 99.1%), rulings per lemma pair (1,563), particle template + residue, 4,223 short paragraphs, verify | M+ (measured; was L) | the one remaining big unit; paragraphs are the irreducible part |
