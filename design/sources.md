...
| **Tatoeba** (jpn/eng/por sentences, links, audio) | example sentences (Japanese = Layer A) | export 2026-06 | sentences **CC BY 2.0 FR**; some audio varies | **Attribution required** (per-sentence credit / Tatoeba). Generally commercial-OK *with* attribution. Audio licenses vary by contributor — check per clip if used. |
